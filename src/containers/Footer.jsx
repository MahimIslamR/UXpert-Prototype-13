          ...
          <div className="flex gap-6 flex-wrap max-[850px]:gap-4">
            <div className="flex gap-4 items-center cursor-pointer text-nowrap">
              ...
              <span className="border-[#1D1D1D] hover:text-[#FF734F] border-b hover:border-[#FF734F] transition-all">
                <a href="https://github.com/MahimIslamR">hello@designproject</a>
              </span>
            </div>
            ...
            <div className="flex gap-4 items-center cursor-pointer text-nowrap">
              ...
              <span className="border-[#1D1D1D] hover:text-[#FF734F] border-b hover:border-[#FF734F] transition-all">
                <a href="https://github.com/MahimIslamR">@designproject</a>
              </span>
            </div>
            ...
            <div className="flex gap-4 items-center cursor-pointer text-nowrap">
              ...
              <span className="border-[#1D1D1D] hover:text-[#FF734F] border-b hover:border-[#FF734F] transition-all">
                <a href="https://www.linkedin.com/in/mahim-islam-roman-b02483286?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">The Design Project</a>
              </span>
            </div>
          </div>
        </div>
